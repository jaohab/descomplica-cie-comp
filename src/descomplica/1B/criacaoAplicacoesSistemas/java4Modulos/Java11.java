...
public class Java11 {
    ...
    public static void soma () {
        ...
        JOptionPane.showMessageDialog(null, "A soma e " + (n1 + n2));
    }
    ...
    public static void subtracao (int x, int y) {
        ...
        JOptionPane.showMessageDialog(null, "A diferenca e " + s);
    }
     ...
     public static void main (String entrada[]) {
        ...
        s = produto();
        JOptionPane.showMessageDialog(null, "O produto e " + s);

        r = divisao(n1, n2);
        JOptionPane.showMessageDialog(null, "A divisao e " + r);
